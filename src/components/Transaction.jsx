...
export default function Transaction() {
    ...
    const [currentTransactionOption, setCurrentTransactionOption] =
        useState("deposit");
        ...
        <div className="transaction-page">
            ...
            <div className="right-col">
                ...
                <div className="transaction">
                    ...
                    <img
                        src="https://cdn-icons.flaticon.com/png/128/3313/premium/3313001.png?token=exp=1659420933~hmac=d3cf01b62b685957ed0f3773ba2a0890"
                        alt=""
                    />
                    <div className="currency-volume">
                        <select name="currency" id="">
